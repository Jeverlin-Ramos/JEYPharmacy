                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-success mt-auto" href="{{ route('seleccionar-producto', ['idPedido' =>$idPedido, 'idProducto' => $producto->id, 'cantidad' => 1, 'precio' => $producto->precio]) }}">Añadir producto</a></div>
                                </div>
                            </div>
                        </div>
                        @endforeach
