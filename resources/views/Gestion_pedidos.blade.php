   ...
   <div class="container pb-5 mb-2">
    ...
    <div class="d-flex justify-content-center">
      <form class="form my-2 my-lg-0">
        ...
        <a href="{{ route('detalle-pedido', ['idPedido' => $pedido->id]) }}">

        <!-- Cart Item-->
        <div class="cart-item d-md-flex justify-content-between">
            <div class="px-3 my-3">
                <a class="cart-item-product" href="{{ route('detalle-pedido', ['idPedido' => $pedido->id]) }}">
                    <div class="cart-item-product-thumb"><img src="{{asset('images/logo-cuadrado.png')}}" alt="Product"></div>
                    <div class="cart-item-product-info">
                      <h4 class="cart-item-product-title">{{ $pedido->user->name }}</h4>
                      <span><strong>Fecha:</strong> {{\Carbon\Carbon::parse($pedido->Fecha_pedido)->format('d-m-Y') }}</span>
