...
.form-control-sm:not(textarea) {
    ...
    <body>
        ...
        <div class="container padding-bottom-3x mb-1">
            <!-- Alert-->
            <div class="alert alert-info alert-dismissible fade show text-center" style="margin-bottom: 30px;"><span class="alert-close" data-dismiss="alert"></span>Detalles del <strong>pedido</strong></div>
            <!-- Shopping Cart-->
            ...
            <div class="shopping-cart-footer">
                <div class="column"><a class="btn btn-outline-secondary" href="/gestion-pedidos"><i class="icon-arrow-left"></i>&nbsp;Volver a la página principal</a></div>
                <div class="column">
